...
重新思考问题，找到十星级产品，挑战前提，在能创造更好产品时扩展范围。四种模式：
SCOPE EXPANSION（大胆梦想）、SELECTIVE EXPANSION（保持范围 + 精选扩展）、
HOLD SCOPE（最大严谨度）、SCOPE REDUCTION（精简到本质）。
当被要求"think bigger"、"expand scope"、"strategy review"、"rethink this"、
或"is this ambitious enough"时使用。
当用户质疑计划的范围或雄心时主动建议，或在计划感觉可以更大胆时主动建议。
