...
preamble-tier: 1
version: 1.0.0
description: 从你真实的 Chromium 浏览器导入 cookie 到 headless 浏览会话中。(gstack)
triggers:
...
打开交互式选择器 UI，让你选择要导入的 cookie 域。
在 QA 测试认证页面之前使用。当被要求"import cookies"、
"login to the site"、或"authenticate the browser"时使用。
